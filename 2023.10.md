...
* Post-retrospective meeting to highlight the essential bits for the
    conference.

Sunday 29 (1 hour)

* Creating a template for the video thumbnails.
* Disabling the notification scripts to get emails on discord.
